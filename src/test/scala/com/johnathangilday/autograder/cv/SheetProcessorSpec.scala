...
class SheetProcessorSpec extends FlatSpec with Matchers with SheetProcessorComponentImpl {
  ...
  "A sample exam (generated by a computer)" should behave like markedTestImage(TestImgFactory.markedBufImg)

  "A sample exam (marked with pencil)" should behave like markedTestImage(TestImgFactory.pencilMarkedBufImg)
